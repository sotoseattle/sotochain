defmodule WalletTest do
  ...
  test "more verifications" do
    ...
    sign = %Signature{
      key: public_key,
      hash:
        Utilities.hex_2_int("ec208baa0fc1c19f708a9ca96fdeff3ac3f230bb4a7ba4aede4942ad003c0f60"),
      r: Utilities.hex_2_int("ac8d1c87e51d0d441be8b3dd5b05c8795b48875dffe00b7ffcfac23010d3a395"),
      s: Utilities.hex_2_int("68342ceff8935ededd102dd876ffd6ba72d6a427a3edb13d26eb0781cb423c4")
    }
    ...
    sign = %Signature{
      key: public_key,
      hash:
        Utilities.hex_2_int("7c076ff316692a3d7eb3c3bb0f8b1488cf72e1afcd929e29307032997a838a3d"),
      r: Utilities.hex_2_int("eff69ef2b1bd93a66ed5219add4fb51e11a840f404876325a1e8ffe0529a2c"),
      s: Utilities.hex_2_int("c7207fee197d27c618aea621406f6bf5ef6fca38681d82b2f06fddbdce6feab6")
    }
