defmodule WalletTest do
  ...
  test "more verifications" do
    ...
    sign = %Signature{
      key: public_key,
      hash: Point256.hex_int("ec208baa0fc1c19f708a9ca96fdeff3ac3f230bb4a7ba4aede4942ad003c0f60"),
    ...
    sign = %Signature{
      key: public_key,
      hash: Point256.hex_int("7c076ff316692a3d7eb3c3bb0f8b1488cf72e1afcd929e29307032997a838a3d"),
